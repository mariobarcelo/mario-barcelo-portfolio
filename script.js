...
const getButtonTheme = localStorage.getItem('portfolio-button-theme')
...
const setTheme = (bodyClass, buttonClass) => {
	...
	buttonTheme.classList.remove(localStorage.getItem('portfolio-button-theme'))
	body.classList.add(bodyClass)
	buttonTheme.classList.add(buttonClass)
	localStorage.setItem('portfolio-theme', bodyClass)
	localStorage.setItem('portfolio-button-theme', buttonClass)
...
function changeProfilePhoto (bodyClass) {
	if(bodyClass == "dark") {
		profilePhoto.setAttribute("src","./img/mario-barcelo-profile-dark-mode.png");
	} else {
